(ns clj-kondo-fix.impl.fixes.java-static-field-call
...
(defn fix-java-static-field-call-in-file [file-path lines findings log]
                               ...
                               (let [[close-line close-col] close-pos]
                                 (if (not= close-line line-idx)
                                   ...
                                   (let [line     (nth current-lines line-idx)
                                         inner    (subs line (inc col-idx) close-col)
